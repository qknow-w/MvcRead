var ViewModel=function() {
    ...
    self.clickEditt = function (data) {
       ...
       /* $.ajax({
        ...
        self.editData.DataName(data.DataName);
        /*self.editData.CaseReasonId(data.CaseReasonId);下拉*/
        self.editData.source(data.source);
        self.editData.totals(data.totals);
        self.editData.DataDescription(data.DataDescription);
        self.editData.suspect(data.suspect);
        self.editData.CaseReason(data.CaseReason);
